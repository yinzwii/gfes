...
public class MinioUtils {
     ...
     */
    @SneakyThrows
    public void putObject(String bucketName, long size, String type, InputStream  inputStream, String filename) {
        PutObjectOptions putObjectOptions = new PutObjectOptions(size, MinioUtils.MIN_MULTIPART_SIZE);
        putObjectOptions.setContentType(type);
     ...
     */
    @SneakyThrows
    public void overwritingUploadObject(String bucketName, long size, String type, InputStream  inputStream, String filename) {
        PutObjectOptions putObjectOptions = new PutObjectOptions(size, MinioUtils.MIN_MULTIPART_SIZE);
        putObjectOptions.setContentType(type);
